...
public class ChoucairLoginPage extends PageObject {
    ...
    public static final Target
            LOGIN_BUTTON = Target.the("button that shows us the form to login").located
    ...
    public static final Target INPUT_PASSWORD = Target.the("where do we the password").located(By.id("password"));
