...
public class ChoucairAcademyStepDefinitions {
    ...
    @When("^he search for the course (.*) Bancolombia on the choucair academy platform$")
    public void heSearchForTheCourseRecursosAutomatizacionBancolombiaOnTheChoucairAcademyPlatforms(List<AcademyChoucairData>academyChoucairData) throws Exception{
